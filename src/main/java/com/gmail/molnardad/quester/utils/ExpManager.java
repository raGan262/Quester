...
public class ExpManager {
	 ...
	 */
	public ExpManager(final Player player) {
		if(player == null) {
	...
	public static void setHardMaxLevel(final int hardMaxLevel) {
		ExpManager.hardMaxLevel = hardMaxLevel;
	}
	...
	public int getCurrentExp() {
		...
		final int cur = getXpForLevel(lvl) + Math.round(xpRequiredForNextLevel[lvl] * player.getExp());
		return cur;
	}
	...
	private double getCurrentFractionalXP() {
		...
		final int lvl = player.getLevel();
		final double cur = getXpForLevel(lvl) + (double) (xpRequiredForNextLevel[lvl] * player.getExp());
		return cur;
	}
