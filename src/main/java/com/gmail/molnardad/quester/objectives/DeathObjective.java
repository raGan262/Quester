...
public final class DeathObjective extends Objective {
	...
	protected String show(final int progress) {
		final String locStr = location == null ? "anywhere " : String.format(
				"max %d blocks from %.1f %.1f %.1f(" + location.getWorld().getName() + ") ", range,
	...
	protected String info() {
		final String locStr = location == null ? "ANY" : String.format("%.1f %.1f %.1f(" + location
				.getWorld().getName() + ")", location.getX(), location.getY(), location.getZ());
