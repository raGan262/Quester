...
public class ModificationCommands {
	...
	@QCommandLabels({ "info" })
	@QCommand(section = "Mod", desc = "shows detailed info about the quest", max = 1, usage = "[quest_ID]", permission = QConfiguration.PERM_MODIFY)
	...
	@QCommand(section = "Mod", desc = "creates a quest", min = 1, max = 1, usage = "<quest name>", permission = QConfiguration.PERM_MODIFY)
	...
	@QCommand(section = "Mod", desc = "removes the quest", min = 1, max = 1, usage = "<quest ID>", permission = QConfiguration.PERM_MODIFY)
	public void remove(final QCommandContext context, final CommandSender sender) throws QuesterException {
		final String name = qMan.removeQuest(sender.getName(), context.getInt(0), context.getSenderLang()).getName();
	...
	@QCommandLabels({ "name" })
	@QCommand(section = "QMod", desc = "renames the quest", min = 1, max = 1, usage = "<new name>", permission = QConfiguration.PERM_MODIFY)
	...
	@QCommand(section = "Mod", desc = "toggles the state of the quest", max = 1, usage = "[quest ID]", permission = QConfiguration.PERM_MODIFY)
	...
	@QCommand(section = "Mod", desc = "selects the quest", min = 1, max = 1, usage = "<quest ID>", permission = QConfiguration.PERM_MODIFY)
	...
	@QCommandLabels({ "desc" })
	@QCommand(section = "QMod", desc = "quest description manipulation", permission = QConfiguration.PERM_MODIFY)
	...
	@QCommand(section = "QMod", desc = "quest location manipulation", permission = QConfiguration.PERM_MODIFY)
	...
	@QCommand(section = "QMod", desc = "quest modifier manipulation", permission = QConfiguration.PERM_MODIFY)
	...
	@QCommand(section = "QMod", desc = "world restriction manipulation", permission = QConfiguration.PERM_MODIFY)
	...
	@QCommand(section = "Mod", desc = "quest holder manipulation", permission = QConfiguration.PERM_MODIFY)
	...
	@QCommand(section = "QMod", desc = "condition manipulation", permission = QConfiguration.PERM_MODIFY)
	...
	@QCommand(section = "QMod", desc = "event manipulation", permission = QConfiguration.PERM_MODIFY)
	...
	@QCommand(section = "QMod", desc = "objective manipulation", permission = QConfiguration.PERM_MODIFY)
